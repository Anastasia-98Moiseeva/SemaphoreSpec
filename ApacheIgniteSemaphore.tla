...
\* Procedure variable available of procedure acquire at line 72 col 5 changed to available_
\* Procedure variable remaining of procedure acquire at line 73 col 5 changed to remaining_
\* Procedure variable available of procedure release at line 90 col 5 changed to available_r
\* Procedure variable remaining of procedure release at line 91 col 5 changed to remaining_r
CONSTANT defaultInitValue
VARIABLES count, lock, succeedOp, pc, stack
...
vars == << count, lock, succeedOp, pc, stack, available, remaining, retVal, 
           valCount, acquires, available_, remaining_, releases, available_r, 
           remaining_r >>
...
s1(self) == /\ pc[self] = "s1"
            ...
            /\ UNCHANGED << count, lock, succeedOp, stack, available, 
...
s5(self) == /\ pc[self] = "s5"
            ...
            /\ UNCHANGED << count, succeedOp, acquires, available_, remaining_, 
                            releases, available_r, remaining_r >>
...
a4(self) == /\ pc[self] = "a4"
            ...
            /\ stack' = [stack EXCEPT ![self] = Tail(stack[self])]
            /\ UNCHANGED << count, lock, succeedOp, available, remaining, 
...
\* Last modified Sat Jun 06 04:05:41 MSK 2020 by anastasia
